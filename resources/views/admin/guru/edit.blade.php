...
<head>
    ...
    <title>Edit Guru | SMK LABOR PKU </title>
        ...
        <div class="container-lg">
            <div class="siswa align-self-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <form action="/admin/guru/update" method="post" enctype="multipart/form-data">
                            @csrf
                            <!-- Informasi Siswa -->
                            <div class="form-floating mb-2">
                                ...
                                <input type="text" name="nama"
                                    ...
                                    placeholder="" value="{{ $guru->nama }}" required>
                                @error('nama')
                            ...
                            <div class="form-floating mb-2">
                                ...
                                <input type="number" name="nip"
                                    ...
                                    placeholder="" value="{{ $guru->nip }}" required>
                                @error('nip')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-floating mb-2">
                                ...
                                <input type="text" name="mata_pelajaran"
                                    ...
                                    id="mata_pelajaran" placeholder="" required value="{{ $guru->mata_pelajaran }}">
                            ...
                            <div class="form-floating mb-2">
                                ...
                                <input type="number" name="no_tlp"
                                    ...
                                    placeholder="" value="{{ $guru->no_tlp }}" required>
                                @error('no_tlp')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
