                            ...
                            <table class="table table-striped" style=" table-layout: fixed;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 60px;">Ekstrakurikuler</th>
                                        <th style="width: 70px;">Pembina</th>
                                ...
                                <tbody>
                                    @foreach ($eskuls as $eskul)
                                        <tr>
                                            ...
                                            <td>{{ $eskul->pembina ? $eskul->pembina->nama : 'Belum ada pembina' }}</td>

                                            <td>{{ $eskul->deskripsi }}</td>
                                            <td>
                                                <a href="{{ route('admin.eskul.show', $eskul->id) }}"
                                                ...
                                                <a href="/admin/eskul/edit/{{$eskul->id}}" class="btn btn-warning btn-sm"><svg
                                                ...
                                                <form action="{{ route('admin.eskul.destroy', $eskul->id) }}" method="POST"
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        onclick="return confirm('Apakah Anda yakin ingin menghapus ini?')"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
